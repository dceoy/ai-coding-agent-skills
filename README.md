...
- `worker_terra` - Escalation worker for bounded ownership-zone discovery or Luna-documented adaptive decisions, and a constrained Luna-compatible executor when Luna cannot be spawned, with `gpt-5.6-terra`
