...
description: Use Spec Kit prompts from Codex CLI to clarify ambiguous requirements in an existing spec.md. Use when a spec has open questions, needs scope alignment, or requires clarification notes. Follow-up step after spec-kit-specify.
---
...
- `spec-kit-plan` once clarifications are resolved
