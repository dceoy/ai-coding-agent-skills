---
name: spec-kit-plan
description: Use Spec Kit prompts from Codex CLI to generate a technical implementation plan (plan.md) from an existing spec.md. Use after spec-kit-specify and clarification to define architecture, data models, APIs, and technical decisions.
---
...
- `spec-kit-tasks` to generate the task list
- `spec-kit-analyze` for risk/complexity review
