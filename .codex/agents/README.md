...
The routing contract deliberately does not prescribe how much parent conversation history the native runtime inherits. Planner correctness comes from an explicit context packet, and advisor independence comes from independently inspecting task-specific primary evidence rather than relying on parent-agent conclusions. This keeps the repository policy independent of runtime-specific context-fork behavior.
