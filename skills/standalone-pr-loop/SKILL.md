...
- Treat each accepted subagent as a terminal leaf: it performs its assigned role directly and does not re-enter `standalone-pr-loop` or delegate again.
